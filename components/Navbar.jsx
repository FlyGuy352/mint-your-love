    ...
    return (
        <nav className='w-full py-3 px-4 bg-white'>
            ...
            {<div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70 z-50' : ''}>
                <div className={
                    nav ?
                        'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-lightPink p-10 ease-in duration-500' :
                    ...
                    <div>
                        <div class='flex w-full items-center justify-between'>
                            ...
                            <div onClick={handleNav} className='rounded-full shadow-lg shadow-gray-400 bg-white p-3 cursor-pointer'>
                                <AiOutlineClose />
                            </div>
                        </div>
                        <div className='border-b border-gray-300 my-4'>
                            <p className='w-[85%] md:w-[90%] py-4 text-crimsonRed uppercase tracking-wider'>Immortalize Your Love on the Blockchain</p>
                        </div>
                    </div>
                    <div className='py-4'>
                        <ul>
